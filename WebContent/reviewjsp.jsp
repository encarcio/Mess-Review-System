    ...
    <div class="container">
        <div class=" mx-auto">
            <form action="review" method="POST">
                <h2 class="text-lg-center font-weight-bold text-dark">Mess Food Review</h2>
                <h6 class="text-lg-center font-weight-bold text-dark">We would like your feedback to improve
                    the
                    quality of mess food</h6>
                <h6 class="text-lg-center font-weight-bold text-dark">What is your opinion of the provided
                    mess food?</h6>
                <div class="row">
                    <div class="mx-auto">
                        <div class="feedback">
                ...
                <!--<h6 class="text-lg-center font-weight-bold text-info">Select the Day:</h6> -->
                ...
                <div class="form-group">
                    <label for="message-text" class="col-form-label font-weight-bold text-dark">Please leave
                        your feedback below:</label>
                    <textarea class="form-control" name="suggestion" id="message-text"></textarea>
                </div>
