...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark ">
        <a class="navbar-brand .text-white" href="homejsp.jsp"><img src="logo.png" alt="Rnsit logo" id="logo"><b>RNSIT
                MESS</b></a>
      ...
      <form action="SignUpStudent.html" class="form-inline my-2 my-lg-0" >
        <button class="btn btn-outline-success my-1 my-sm-1 btn-space" type="submit" id="signup">SIGN UP</button>
      </form>
      <form action="login-student.html" class="form-inline my-2 my-lg-0" >
        <button class="btn btn-outline-success my-1 my-sm-1 btn-space" type="submit" id="login">LOGIN</button></a>
      </form>
    </div>
    </nav>
